...
class AccountVoucherLine(models.Model):
    ...
    def _onchange_product_id(self):
        # res = super(AccountVoucherLine, self)._onchange_product_id()
        rec = self.env['account.analytic.default'].account_get(self.product_id.id, self.voucher_id.partner_id.id, self.env.uid,
